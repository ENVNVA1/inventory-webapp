...
const Approvals = () => {
  ...
  const activeList =
    activeTab === 'invoices' ? pendingInvoices : pendingPurchaseDeletions;
  ...
  // Switching tab / page size starts over; approving can shrink the list past
  // the current page, so clamp back onto a valid one.
  useEffect(() => {
    setCurrentPage(1);
